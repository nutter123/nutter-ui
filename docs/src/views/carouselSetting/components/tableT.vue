<template>
  <div class="pl-20">
    <div class="contain has-bread p20">
      <div>
        <!-- 查询表单 -->
        <el-form inline size="small" ref="searchForm" :model="searchForm" class="search-form">
        ...
        >
          ...
          <el-table-column label="操作" fixed="right" min-width="100">
            <template slot-scope="scope">
              ...
              <span class="error-link" v-if="scope.row.indexs<tableParams.total"  @click="shift(scope.row,1)">下移</span>
            </template>
          </el-table-column>
        </el-table>
  ...
  methods: {
    ...
    async loadList() {
      ...
      let result = await this.$apis.carouseSetting.getList(
        this.assignQuery({
          ...this.searchForm,
          productId: "fd6a538c-9461-4591-8cc1-c725c2f996b9"
        })
      );
      let _page = result;
